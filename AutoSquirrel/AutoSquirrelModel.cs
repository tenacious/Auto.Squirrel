...
namespace AutoSquirrel
{
    ...
    public class AutoSquirrelModel : PropertyChangedBaseValidable, GongSolutions.Wpf.DragDrop.IDropTarget
    {
        ...
        internal string CreateNugetPackage()
        {
            ...
            foreach (var node in this.PackageFiles)
            {
            ...
            var nugetPath = NupkgOutputPath + Path.DirectorySeparatorChar + AppId + "." + Version + ".nupkg";
        ...
        private void AddFileToPackage(string directoryBase, ItemLink node, List<ManifestFile> files)
        {
